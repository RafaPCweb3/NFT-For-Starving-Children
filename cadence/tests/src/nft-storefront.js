...
import { deployNftItems, setupNftItemsOnAccount } from "./nft-items";

/*
 * Deploys nftItems and NFTStorefront contracts to NftAdmin.
...
export const deployNFTStorefront = async () => {
	...
	return deployContractByName({ to: NftAdmin, name: "NFTStorefront" });
};
...
export const setupStorefrontOnAccount = async (account) => {
	// Account shall be able to store Nft Items
	await setupNftItemsOnAccount(account);
